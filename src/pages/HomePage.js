...
const steps = [
  {
    image: '/images/steps/design.png',
    title: 'Design your web'
  },
  {
    image: '/images/steps/develop.png',
    title: 'Develop your web'
  },
  {
    image: '/images/steps/product.png',
    title: 'Enjoy your web'
  },
]
      ...
      <Navbar />
        ...
        <section className="home-section-third">
          ...
          <div className="wrapper-covers">
            {
              [...Array(6)].map((_,key) => (
                <img className="img-cover" src={`/images/portfolio/cover-${key+1}.png`} alt={`portfolio-${key+1}`} key={key}/>
              ))
            }
          </div>
        </section>
